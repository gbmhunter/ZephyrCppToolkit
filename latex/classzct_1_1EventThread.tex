...
\item 
using \mbox{\hyperlink{classzct_1_1EventThread_a77eb243229fad898f029acfa56c24cb9}{Msg\+Queue\+Item}} = std\+::variant$<$ Event\+Type, std\+::function$<$ void()$>$ $>$
...
\item 
void \mbox{\hyperlink{classzct_1_1EventThread_af7694a12e45b5ddfe832fe03353cce2b}{run\+In\+Loop}} (std\+::function$<$ void()$>$ func)
\end{DoxyCompactItemize}
...
\item 
void \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{classzct_1_1EventThread_aa1841a2f7b242d13d18fbd2d1e83739b}{m\+\_\+msg\+Queue\+Buffer}} = nullptr
\item 
...
This class works really well with event driven programming and hierarchical state machines (HSM) like Ninja\+HSM.
...
\Hypertarget{classzct_1_1EventThread_a77eb243229fad898f029acfa56c24cb9}\label{classzct_1_1EventThread_a77eb243229fad898f029acfa56c24cb9} 
\index{zct::EventThread$<$ EventType $>$@{zct::EventThread$<$ EventType $>$}!MsgQueueItem@{MsgQueueItem}}
\index{MsgQueueItem@{MsgQueueItem}!zct::EventThread$<$ EventType $>$@{zct::EventThread$<$ EventType $>$}}
\doxysubsubsection{\texorpdfstring{MsgQueueItem}{MsgQueueItem}}
{\footnotesize\ttfamily template$<$typename Event\+Type $>$ \\
using \mbox{\hyperlink{classzct_1_1EventThread}{zct\+::\+Event\+Thread}}$<$ Event\+Type $>$\+::\+Msg\+Queue\+Item =  std\+::variant$<$Event\+Type, std\+::function$<$void()$>$ $>$}
...
This should be called from the thread function that is passed in to the constructor, once any initialisation you want done (e.\+g. setup some timers) has been done. \Hypertarget{classzct_1_1EventThread_af7694a12e45b5ddfe832fe03353cce2b}\label{classzct_1_1EventThread_af7694a12e45b5ddfe832fe03353cce2b} 
\index{zct::EventThread$<$ EventType $>$@{zct::EventThread$<$ EventType $>$}!runInLoop@{runInLoop}}
\index{runInLoop@{runInLoop}!zct::EventThread$<$ EventType $>$@{zct::EventThread$<$ EventType $>$}}
\doxysubsubsection{\texorpdfstring{runInLoop()}{runInLoop()}}
{\footnotesize\ttfamily template$<$typename Event\+Type $>$ \\
void \mbox{\hyperlink{classzct_1_1EventThread}{zct\+::\+Event\+Thread}}$<$ Event\+Type $>$\+::run\+In\+Loop (\begin{DoxyParamCaption}\item[{std\+::function$<$ void()$>$}]{func }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
This is useful when you are in an interrupt context and want "{}signal"{} back to the event thread so it can do something. The std\+::function could call an on\+Interrupt() function in the event thread. This can be called from both other threads and ISRs.
...
\begin{DoxyParams}{Parameters}
{\em func} & The function to run. This will be run in the context of the event thread. \\
\hline
\end{DoxyParams}
...
\Hypertarget{classzct_1_1EventThread_aa1841a2f7b242d13d18fbd2d1e83739b}\label{classzct_1_1EventThread_aa1841a2f7b242d13d18fbd2d1e83739b} 
\index{zct::EventThread$<$ EventType $>$@{zct::EventThread$<$ EventType $>$}!m\_msgQueueBuffer@{m\_msgQueueBuffer}}
\index{m\_msgQueueBuffer@{m\_msgQueueBuffer}!zct::EventThread$<$ EventType $>$@{zct::EventThread$<$ EventType $>$}}
\doxysubsubsection{\texorpdfstring{m\_msgQueueBuffer}{m\_msgQueueBuffer}}
{\footnotesize\ttfamily template$<$typename Event\+Type $>$ \\
void\texorpdfstring{$\ast$}{*} \mbox{\hyperlink{classzct_1_1EventThread}{zct\+::\+Event\+Thread}}$<$ Event\+Type $>$\+::m\+\_\+msg\+Queue\+Buffer = nullptr\hspace{0.3cm}{\ttfamily [protected]}}
