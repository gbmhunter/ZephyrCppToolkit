...
\item 
std\+::function$<$ void()$>$ \mbox{\hyperlink{classzct_1_1EventThread_af82899498638998526e3118fded52e0c}{m\+\_\+thread\+Function}} = nullptr
\item 
...
\DoxyCodeLine{\textcolor{keyword}{typedef}\ std::variant<LedFlashing,\ Exit>\ Generic;}
\DoxyCodeLine{}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//================================================================================================//}}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ ),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ m\_flashingTimer(\textcolor{stringliteral}{"{}FlashingTimer"{}},\ [\textcolor{keyword}{this}]()\ \{\ onFlashingTimerCallback();\ \})}
\DoxyCodeLine{\ \ \ \ \{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{void}\ onFlashingTimerCallback()\ \{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ m\_eventThread.\mbox{\hyperlink{classzct_1_1EventThread_a466b293455fda762c63357549025d8af}{onExternalEvent}}([\textcolor{keyword}{this}](\textcolor{keyword}{const}\ Events::Generic\&\ event)\ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ handleEvent(event);}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \});}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{comment}{//\ Start\ the\ event\ loop\ (this\ never\ returns\ unless\ exitEventLoop\ is\ called)}}
\DoxyCodeLine{\ \ \ \ \ \ \ \ m\_eventThread.\mbox{\hyperlink{classzct_1_1EventThread_a7edd0a4e156e57bf8f3c6832ae3bde68}{runEventLoop}}();}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
...
\hline
{\em thread\+Function} & The function to call when the thread is started. This should do whatever setup you need and then call wait\+For\+Event(). \\
\hline
...
{\footnotesize\ttfamily template$<$typename Event\+Type $>$ \\
void \mbox{\hyperlink{classzct_1_1EventThread}{zct\+::\+Event\+Thread}}$<$ Event\+Type $>$\+::run\+Event\+Loop (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily template$<$typename Event\+Type $>$ \\
std\+::function$<$void()$>$ \mbox{\hyperlink{classzct_1_1EventThread}{zct\+::\+Event\+Thread}}$<$ Event\+Type $>$\+::m\+\_\+thread\+Function = nullptr\hspace{0.3cm}{\ttfamily [protected]}}
