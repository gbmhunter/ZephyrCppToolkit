...
\hypertarget{_2examples_2IntegrationTest_2src_2App_8cpp-example}{}\label{_2examples_2IntegrationTest_2src_2App_8cpp-example}This is an example of how to use the \doxylink{classzct_1_1EventThread}{zct\+::\+Event\+Thread} class to create a thread that can wait for events.
...
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ "{}ZephyrCppToolkit/EventThreadv2.hpp"{}}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ "{}App.hpp"{}}}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{Mutex_8cpp_afc6fa2df10e04ba2ac7a6ab62c6d25e6}{LOG\_MODULE\_REGISTER}}(App,\ LOG\_LEVEL\_DBG);}
\DoxyCodeLine{}
